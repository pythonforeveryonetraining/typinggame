...
class Renderer(Window):
    def __init__(self, game):
        ...
        self.stars = []
        for _ in range(20):
            self.stars.append(Rectangle(random.randint(0, self.width), random.randint(0, self.height), 4, 4, color=(132, 94, 194, 255)))
...
class Game:
    ...
    def new_round(self):
        self.word = self.words[0]#random.choice(self.words)
